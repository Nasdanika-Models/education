...
public class EducationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EducationPackage.SCHOOL: {
				School school = (School)theEObject;
				T result = caseSchool(school);
				if (result == null) result = caseParty(school);
				if (result == null) result = caseDocumentedNamedStringIdentity(school);
				if (result == null) result = caseDocumentedNamedElement(school);
				if (result == null) result = caseStringIdentity(school);
				if (result == null) result = caseNamedElement(school);
				if (result == null) result = caseDocumented(school);
				if (result == null) result = caseModelElement(school);
				if (result == null) result = caseMarked(school);
				if (result == null) result = caseAdaptable(school);
				if (result == null) result = caseIMarked(school);
